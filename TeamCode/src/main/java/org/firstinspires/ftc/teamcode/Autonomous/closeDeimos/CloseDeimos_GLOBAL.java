...
public class CloseDeimos_GLOBAL extends OpModeCommand {
    ...
    private PathChain intakeFirst, launchFirst, openGate1, intakeSecond, launchSecond, openGate2, intakeThird, launchThird, intakeFourth, launchFourth;
    ...
    static Pose shoot2Pose = new Pose(85.0, 76.0, Math.toRadians(330));

    static Pose opengate2ControlPoint = new Pose(100, 64, Math.toRadians(0));
    static Pose opengate2Pose = new Pose(126, 66.0, Math.toRadians(0));
    static Pose pick3ControlPoint = new Pose(125, 52, Math.toRadians(20));
    static Pose pick3Pose = new Pose(135.0, 51.0, Math.toRadians(80));

    static Pose shoot3ControlPoint = new Pose(99, 62.0, Math.toRadians(0));

    static Pose shoot3Pose = new Pose(88.0, 86.0, Math.toRadians(0));

    static Pose pickUp4Pose = new Pose(127.0, 86.0, Math.toRadians(0));
    ...
    public void initialize() {
        ...
        autoCommand = new SequentialCommandGroup(
                ...
                pedroSb.followPathCmd(intakeFourth).withTimeout(1200),
